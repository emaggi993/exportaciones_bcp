...
################################################################################
## Form generated from reading UI file 'template_table_widget.ui'
##
...
class template_table_widget(object):
    def setupUi(self, template_table_widget):
        if not template_table_widget.objectName():
            template_table_widget.setObjectName(u"template_table_widget")
        template_table_widget.resize(769, 488)
        template_table_widget.setStyleSheet(u"border-radius: 5px;")
        self.verticalLayout = QVBoxLayout(template_table_widget)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.central_frame = QFrame(template_table_widget)
...
"color: rgb(255,255,255)")
        ...
        self.retranslateUi(template_table_widget)

        QMetaObject.connectSlotsByName(template_table_widget)
    # setupUi

    def retranslateUi(self, template_table_widget):
        template_table_widget.setWindowTitle(QCoreApplication.translate("template_table_widget", u"Form", None))
        self.title_label.setText(QCoreApplication.translate("template_table_widget", u"Exportaciones - MF Econom\u00eda e Inversiones", None))
        self.minimize_button.setText(QCoreApplication.translate("template_table_widget", u"...", None))
        self.restore_button.setText(QCoreApplication.translate("template_table_widget", u"...", None))
        self.close_button.setText(QCoreApplication.translate("template_table_widget", u"...", None))
        self.maximize_button.setText(QCoreApplication.translate("template_table_widget", u"...", None))
    # retranslateUi
